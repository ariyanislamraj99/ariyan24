...
const toolComponents: Record<string, React.LazyExoticComponent<any>> = {
  ...
  "serp-preview": lazy(() => import("@/tools/SerpPreview")),
  "serp-simulator": lazy(() => import("@/tools/SerpSimulator")),
  "title-tag-optimizer": lazy(() => import("@/tools/TitleTagOptimizer")),
  "meta-desc-writer": lazy(() => import("@/tools/MetaDescWriter")),
  "keyword-clustering": lazy(() => import("@/tools/KeywordClustering")),
  "keyword-gap-analyzer": lazy(() => import("@/tools/KeywordGapAnalyzer")),
  "long-tail-keyword-gen": lazy(() => import("@/tools/LongTailKeywordGen")),
  "lsi-keyword-gen": lazy(() => import("@/tools/LsiKeywordGen")),
  "keyword-position-checker": lazy(() => import("@/tools/KeywordPositionChecker")),
  "keyword-difficulty-calc": lazy(() => import("@/tools/KeywordDifficultyCalc")),
  "search-volume-estimator": lazy(() => import("@/tools/SearchVolumeEstimator")),
  "cpc-calculator": lazy(() => import("@/tools/CpcCalculator")),
  "content-gap-finder": lazy(() => import("@/tools/ContentGapFinder")),
  "content-brief-gen": lazy(() => import("@/tools/ContentBriefGen")),
  "content-outline-gen": lazy(() => import("@/tools/ContentOutlineGen")),
  "content-scoring": lazy(() => import("@/tools/ContentScoring")),
  "content-readability": lazy(() => import("@/tools/ContentReadabilityOpt")),
  "internal-link-analyzer": lazy(() => import("@/tools/InternalLinkAnalyzer")),
  "backlink-analyzer": lazy(() => import("@/tools/BacklinkAnalyzer")),
  "anchor-text-analyzer": lazy(() => import("@/tools/AnchorTextAnalyzer")),
  "link-building-planner": lazy(() => import("@/tools/LinkBuildingPlanner")),
  "disavow-file-gen": lazy(() => import("@/tools/DisavowFileGen")),
  "hreflang-gen": lazy(() => import("@/tools/HreflangGen")),
  "pagination-tag-gen": lazy(() => import("@/tools/PaginationTagGen")),
  "breadcrumb-schema-gen": lazy(() => import("@/tools/BreadcrumbSchemaGen")),
  "faq-schema-gen": lazy(() => import("@/tools/FaqSchemaGen")),
  "howto-schema-gen": lazy(() => import("@/tools/HowtoSchemaGen")),
  "product-schema-gen": lazy(() => import("@/tools/ProductSchemaGen")),
  "review-schema-gen": lazy(() => import("@/tools/ReviewSchemaGen")),
  "event-schema-gen": lazy(() => import("@/tools/EventSchemaGen")),
  "recipe-schema-gen": lazy(() => import("@/tools/RecipeSchemaGen")),
  "video-schema-gen": lazy(() => import("@/tools/VideoSchemaGen")),
  "article-schema-gen": lazy(() => import("@/tools/ArticleSchemaGen")),
  "local-business-schema": lazy(() => import("@/tools/LocalBusinessSchema")),
  "organization-schema": lazy(() => import("@/tools/OrganizationSchema")),
  "person-schema-gen": lazy(() => import("@/tools/PersonSchemaGen")),
  "job-posting-schema": lazy(() => import("@/tools/JobPostingSchema")),
  "course-schema-gen": lazy(() => import("@/tools/CourseSchemaGen")),
  "software-schema-gen": lazy(() => import("@/tools/SoftwareSchemaGen")),
  "page-speed-analyzer": lazy(() => import("@/tools/PageSpeedAnalyzer")),
  "core-web-vitals": lazy(() => import("@/tools/CoreWebVitals")),
  "mobile-friendly-test": lazy(() => import("@/tools/MobileFriendlyTest")),
  "amp-validator": lazy(() => import("@/tools/AmpValidator")),
  "rich-snippet-tester": lazy(() => import("@/tools/RichSnippetTester")),
  "seo-audit-checklist": lazy(() => import("@/tools/SeoAuditChecklist")),
  "technical-seo-checker": lazy(() => import("@/tools/TechnicalSeoChecker")),
  "crawl-budget-calc": lazy(() => import("@/tools/CrawlBudgetCalc")),
  "index-coverage-checker": lazy(() => import("@/tools/IndexCoverageChecker")),
  "duplicate-content-check": lazy(() => import("@/tools/DuplicateContentCheck")),
  "thin-content-finder": lazy(() => import("@/tools/ThinContentFinder")),
  "image-seo-checker": lazy(() => import("@/tools/ImageSeoChecker")),
  "video-seo-checker": lazy(() => import("@/tools/VideoSeoChecker")),
  "local-seo-checker": lazy(() => import("@/tools/LocalSeoChecker")),
  "ecommerce-seo-checker": lazy(() => import("@/tools/EcommerceSeoChecker")),
  "blog-seo-analyzer": lazy(() => import("@/tools/BlogSeoAnalyzer")),
  "seo-title-case": lazy(() => import("@/tools/SeoTitleCase")),
  "seo-url-analyzer": lazy(() => import("@/tools/SeoUrlAnalyzer")),
  "redirect-map-gen": lazy(() => import("@/tools/RedirectMapGen")),
  "xml-sitemap-gen-adv": lazy(() => import("@/tools/XmlSitemapGenAdv")),
  "html-sitemap-gen": lazy(() => import("@/tools/HtmlSitemapGen")),
  "news-sitemap-gen": lazy(() => import("@/tools/NewsSitemapGen")),
  "image-sitemap-gen": lazy(() => import("@/tools/ImageSitemapGen")),
  "video-sitemap-gen": lazy(() => import("@/tools/VideoSitemapGen")),
  "google-analytics-gen": lazy(() => import("@/tools/GoogleAnalyticsGen")),
  "gtm-code-gen": lazy(() => import("@/tools/GtmCodeGen")),
  "conversion-rate-calc": lazy(() => import("@/tools/ConversionRateCalc")),
  "roi-calculator": lazy(() => import("@/tools/RoiCalculator")),
  "traffic-estimator": lazy(() => import("@/tools/TrafficEstimator")),
  "ab-test-calc": lazy(() => import("@/tools/AbTestCalc")),
  "click-through-calc": lazy(() => import("@/tools/ClickThroughCalc")),
  "bounce-rate-analyzer": lazy(() => import("@/tools/BounceRateAnalyzer")),
  "page-authority-calc": lazy(() => import("@/tools/PageAuthorityCalc")),
  "domain-authority-calc": lazy(() => import("@/tools/DomainAuthorityCalc")),
  "competitor-seo-analyzer": lazy(() => import("@/tools/CompetitorSeoAnalyzer")),
  "featured-snippet-opt": lazy(() => import("@/tools/FeaturedSnippetOpt")),
};
