...
export const tools: Tool[] = [
  ...
  // ═══════════════════════════════════════
  { id: "http-header-checker", name: "HTTP Header Checker", description: "Inspect HTTP response headers of any URL", category: "web", icon: Globe, implemented: false },
  { id: "dns-lookup", name: "DNS Lookup Tool", description: "Look up DNS records for any domain", category: "web", icon: Search, implemented: false },
  { id: "whois-lookup", name: "WHOIS Lookup", description: "Get domain registration details", category: "web", icon: Globe, implemented: false },
  { id: "website-speed-test", name: "Website Speed Tester", description: "Analyze website loading performance", category: "web", icon: Gauge, implemented: false },
  { id: "redirect-checker", name: "Redirect Checker", description: "Trace URL redirect chains", category: "web", icon: RefreshCw, implemented: false },
  { id: "broken-link-checker", name: "Broken Link Checker", description: "Find broken links on a webpage", category: "web", icon: XCircle, implemented: false },
  { id: "html-to-markdown", name: "HTML to Markdown", description: "Convert HTML markup to Markdown", category: "web", icon: FileCode, implemented: false },
  { id: "html-to-jsx", name: "HTML to JSX Converter", description: "Convert HTML to React JSX syntax", category: "web", icon: Code, implemented: false },
  { id: "html-to-pug", name: "HTML to Pug Converter", description: "Convert HTML to Pug/Jade template syntax", category: "web", icon: Code, implemented: false },
  { id: "html-table-generator", name: "HTML Table Generator", description: "Generate HTML tables visually", category: "web", icon: Grid, implemented: false },
  { id: "css-formatter", name: "CSS Formatter", description: "Format and beautify CSS code", category: "web", icon: FileCode, implemented: false },
  { id: "css-gradient-animator", name: "CSS Gradient Animator", description: "Create animated CSS gradients", category: "web", icon: Palette, implemented: false },
  { id: "css-clip-path-gen", name: "CSS Clip Path Generator", description: "Create complex CSS clip-path shapes", category: "web", icon: Scissors, implemented: false },
  { id: "css-filter-gen", name: "CSS Filter Generator", description: "Create CSS filter effects visually", category: "web", icon: Eye, implemented: false },
  { id: "css-animation-gen", name: "CSS Animation Generator", description: "Build CSS keyframe animations", category: "web", icon: Zap, implemented: false },
  { id: "css-triangle-gen", name: "CSS Triangle Generator", description: "Generate CSS triangle shapes", category: "web", icon: Maximize, implemented: false },
  { id: "css-scrollbar-gen", name: "CSS Scrollbar Styler", description: "Customize scrollbar CSS styles", category: "web", icon: AlignLeft, implemented: false },
  { id: "css-button-gen", name: "CSS Button Generator", description: "Design custom CSS buttons visually", category: "web", icon: Paintbrush, implemented: false },
  { id: "css-loader-gen", name: "CSS Loader Generator", description: "Create CSS loading spinner animations", category: "web", icon: RotateCw, implemented: false },
  { id: "css-tooltip-gen", name: "CSS Tooltip Generator", description: "Generate pure CSS tooltips", category: "web", icon: Info, implemented: false },
  { id: "tailwind-to-css", name: "Tailwind to CSS", description: "Convert Tailwind classes to plain CSS", category: "web", icon: Wand2, implemented: false },
  { id: "sass-to-css", name: "SASS to CSS Compiler", description: "Compile SASS/SCSS to plain CSS", category: "web", icon: Code, implemented: false },
  { id: "less-to-css", name: "LESS to CSS Compiler", description: "Compile LESS to plain CSS", category: "web", icon: Code, implemented: false },
  { id: "json-validator", name: "JSON Validator", description: "Validate JSON syntax and structure", category: "web", icon: CheckCircle, implemented: false },
  { id: "json-path-finder", name: "JSON Path Finder", description: "Find and test JSONPath expressions", category: "web", icon: Search, implemented: false },
  { id: "json-diff", name: "JSON Diff Tool", description: "Compare two JSON objects visually", category: "web", icon: AlignCenter, implemented: false },
  { id: "json-to-xml", name: "JSON to XML Converter", description: "Convert JSON data to XML format", category: "web", icon: RefreshCw, implemented: false },
  { id: "xml-to-json", name: "XML to JSON Converter", description: "Convert XML data to JSON format", category: "web", icon: RefreshCw, implemented: false },
  { id: "xml-formatter", name: "XML Formatter", description: "Format and beautify XML documents", category: "web", icon: FileCode, implemented: false },
  { id: "xml-validator", name: "XML Validator", description: "Validate XML syntax and structure", category: "web", icon: CheckCircle, implemented: false },
  { id: "graphql-formatter", name: "GraphQL Formatter", description: "Format and beautify GraphQL queries", category: "web", icon: Braces, implemented: false },
  { id: "api-request-builder", name: "API Request Builder", description: "Build and test API requests visually", category: "web", icon: Globe, implemented: false },
  { id: "curl-to-code", name: "cURL to Code Converter", description: "Convert cURL commands to code", category: "web", icon: Terminal, implemented: false },
  { id: "code-to-curl", name: "Code to cURL Converter", description: "Convert fetch/axios to cURL commands", category: "web", icon: Terminal, implemented: false },
  { id: "http-status-codes", name: "HTTP Status Code Reference", description: "Browse all HTTP status codes & meanings", category: "web", icon: Info, implemented: false },
  { id: "mime-type-lookup", name: "MIME Type Lookup", description: "Find MIME types for file extensions", category: "web", icon: FileText, implemented: false },
  { id: "user-agent-parser", name: "User Agent Parser", description: "Parse and decode user agent strings", category: "web", icon: Monitor, implemented: false },
  { id: "ip-to-geolocation", name: "IP to Geolocation", description: "Convert IP address to location data", category: "web", icon: MapPin, implemented: false },
  { id: "domain-age-checker", name: "Domain Age Checker", description: "Check how old a domain is", category: "web", icon: Calendar, implemented: false },
  { id: "ssl-cert-generator", name: "SSL CSR Generator", description: "Generate certificate signing requests", category: "web", icon: Lock, implemented: false },
  { id: "cors-header-gen", name: "CORS Header Generator", description: "Generate CORS configuration headers", category: "web", icon: Shield, implemented: false },
  { id: "sri-hash-gen", name: "SRI Hash Generator", description: "Generate Subresource Integrity hashes", category: "web", icon: Lock, implemented: false },
  { id: "cookie-analyzer", name: "Cookie Analyzer", description: "Analyze and decode browser cookies", category: "web", icon: Database, implemented: false },
  { id: "jwt-generator", name: "JWT Token Generator", description: "Create and sign JWT tokens", category: "web", icon: Key, implemented: false },
  { id: "oauth-url-builder", name: "OAuth URL Builder", description: "Build OAuth authorization URLs", category: "web", icon: Link, implemented: false },
  ...
  { id: "srcset-generator", name: "Srcset Generator", description: "Generate responsive image srcset markup", category: "web", icon: Image, implemented: false },
  { id: "picture-tag-gen", name: "Picture Tag Generator", description: "Generate responsive <picture> elements", category: "web", icon: Image, implemented: false },
  { id: "lazy-load-gen", name: "Lazy Load Code Generator", description: "Generate lazy loading code for images", category: "web", icon: Download, implemented: false },
  { id: "preload-gen", name: "Resource Preload Generator", description: "Generate preload/prefetch link tags", category: "web", icon: Zap, implemented: false },
  { id: "service-worker-gen", name: "Service Worker Generator", description: "Generate basic service worker scripts", category: "web", icon: Settings, implemented: false },
  { id: "manifest-gen", name: "Web App Manifest Generator", description: "Create PWA manifest.json files", category: "web", icon: Smartphone, implemented: false },
  { id: "structured-data-test", name: "Structured Data Tester", description: "Validate JSON-LD structured data", category: "web", icon: CheckCircle, implemented: false },
  { id: "webpack-config-gen", name: "Webpack Config Generator", description: "Generate webpack configuration files", category: "web", icon: Settings, implemented: false },
  { id: "vite-config-gen", name: "Vite Config Generator", description: "Generate Vite configuration files", category: "web", icon: Zap, implemented: false },
  { id: "nginx-config-gen", name: "Nginx Config Generator", description: "Generate Nginx server configuration", category: "web", icon: Terminal, implemented: false },
  { id: "apache-config-gen", name: "Apache Config Generator", description: "Generate Apache virtual host configs", category: "web", icon: Terminal, implemented: false },
  { id: "docker-compose-gen", name: "Docker Compose Generator", description: "Create docker-compose.yml files visually", category: "web", icon: Layers, implemented: false },
  { id: "env-file-gen", name: "ENV File Generator", description: "Generate .env file templates", category: "web", icon: FileText, implemented: false },
  { id: "gitignore-gen", name: ".gitignore Generator", description: "Create .gitignore for any tech stack", category: "web", icon: FileText, implemented: false },
  { id: "readme-gen", name: "README Generator", description: "Generate professional README.md files", category: "web", icon: BookOpen, implemented: false },
  { id: "license-gen", name: "License Generator", description: "Generate open source license files", category: "web", icon: FileText, implemented: false },
  { id: "changelog-gen", name: "Changelog Generator", description: "Create CHANGELOG.md templates", category: "web", icon: List, implemented: false },
  { id: "privacy-policy-gen", name: "Privacy Policy Generator", description: "Generate privacy policy templates", category: "web", icon: Shield, implemented: false },
  { id: "terms-of-service-gen", name: "Terms of Service Generator", description: "Generate terms of service templates", category: "web", icon: FileText, implemented: false },
  { id: "cookie-consent-gen", name: "Cookie Consent Generator", description: "Generate cookie consent banners", category: "web", icon: Info, implemented: false },
  { id: "accessibility-checker", name: "Accessibility Checker", description: "Check HTML for WCAG accessibility issues", category: "web", icon: Eye, implemented: false },
  { id: "contrast-checker", name: "Color Contrast Checker", description: "Check WCAG color contrast ratios", category: "web", icon: Eye, implemented: false },
  { id: "aria-gen", name: "ARIA Attributes Helper", description: "Generate proper ARIA attributes", category: "web", icon: HelpCircle, implemented: false },
  { id: "og-image-gen", name: "OG Image Generator", description: "Create Open Graph images from templates", category: "web", icon: Image, implemented: false },
  { id: "mailto-link-gen", name: "Mailto Link Generator", description: "Generate mailto links with subject & body", category: "web", icon: Mail, implemented: false },
  { id: "tel-link-gen", name: "Tel Link Generator", description: "Generate clickable phone number links", category: "web", icon: Smartphone, implemented: false },
  { id: "embed-code-gen", name: "Embed Code Generator", description: "Generate iframe embed codes", category: "web", icon: Code, implemented: false },
  ...
  { id: "long-tail-keyword-gen", name: "Long Tail Keyword Generator", description: "Generate long-tail keyword variations", category: "seo", icon: TrendingUp, implemented: false },
  { id: "lsi-keyword-gen", name: "LSI Keyword Generator", description: "Generate latent semantic keywords", category: "seo", icon: Search, implemented: false },
  { id: "keyword-position-checker", name: "Keyword Position Checker", description: "Check keyword ranking positions", category: "seo", icon: Target, implemented: false },
  { id: "keyword-difficulty-calc", name: "Keyword Difficulty Calculator", description: "Estimate keyword competition level", category: "seo", icon: Gauge, implemented: false },
  { id: "search-volume-estimator", name: "Search Volume Estimator", description: "Estimate monthly search volumes", category: "seo", icon: BarChart, implemented: false },
  { id: "cpc-calculator", name: "CPC Calculator", description: "Estimate cost-per-click for keywords", category: "seo", icon: DollarSign, implemented: false },
  { id: "content-gap-finder", name: "Content Gap Finder", description: "Identify missing content opportunities", category: "seo", icon: Search, implemented: false },
  { id: "content-brief-gen", name: "Content Brief Generator", description: "Generate SEO content briefs", category: "seo", icon: FileText, implemented: false },
  { id: "content-outline-gen", name: "Content Outline Generator", description: "Create structured content outlines", category: "seo", icon: List, implemented: false },
  { id: "content-scoring", name: "Content SEO Scorer", description: "Score content for SEO optimization", category: "seo", icon: Activity, implemented: false },
  { id: "content-readability", name: "Content Readability Optimizer", description: "Improve content readability for SEO", category: "seo", icon: BookOpen, implemented: false },
  { id: "internal-link-analyzer", name: "Internal Link Analyzer", description: "Analyze internal linking structure", category: "seo", icon: Link, implemented: false },
  { id: "backlink-analyzer", name: "Backlink Profile Analyzer", description: "Analyze backlink quality and diversity", category: "seo", icon: Link, implemented: false },
  { id: "anchor-text-analyzer", name: "Anchor Text Analyzer", description: "Analyze anchor text distribution", category: "seo", icon: Link, implemented: false },
  { id: "link-building-planner", name: "Link Building Planner", description: "Plan link building campaigns", category: "seo", icon: Target, implemented: false },
  { id: "disavow-file-gen", name: "Disavow File Generator", description: "Generate Google disavow files", category: "seo", icon: XCircle, implemented: false },
  { id: "hreflang-gen", name: "Hreflang Tag Generator", description: "Generate hreflang tags for multilingual sites", category: "seo", icon: Globe, implemented: false },
  { id: "pagination-tag-gen", name: "Pagination Tag Generator", description: "Generate rel=next/prev pagination tags", category: "seo", icon: List, implemented: false },
  { id: "breadcrumb-schema-gen", name: "Breadcrumb Schema Generator", description: "Generate breadcrumb structured data", category: "seo", icon: Navigation, implemented: false },
  { id: "faq-schema-gen", name: "FAQ Schema Generator", description: "Generate FAQ page structured data", category: "seo", icon: HelpCircle, implemented: false },
  { id: "howto-schema-gen", name: "HowTo Schema Generator", description: "Generate HowTo structured data", category: "seo", icon: BookOpen, implemented: false },
  { id: "product-schema-gen", name: "Product Schema Generator", description: "Generate product structured data", category: "seo", icon: Tag, implemented: false },
  { id: "review-schema-gen", name: "Review Schema Generator", description: "Generate review/rating structured data", category: "seo", icon: Star, implemented: false },
  { id: "event-schema-gen", name: "Event Schema Generator", description: "Generate event structured data", category: "seo", icon: Calendar, implemented: false },
  { id: "recipe-schema-gen", name: "Recipe Schema Generator", description: "Generate recipe structured data", category: "seo", icon: BookOpen, implemented: false },
  { id: "video-schema-gen", name: "Video Schema Generator", description: "Generate VideoObject structured data", category: "seo", icon: Video, implemented: false },
  { id: "article-schema-gen", name: "Article Schema Generator", description: "Generate article structured data", category: "seo", icon: FileText, implemented: false },
  { id: "local-business-schema", name: "Local Business Schema", description: "Generate LocalBusiness structured data", category: "seo", icon: MapPin, implemented: false },
  { id: "organization-schema", name: "Organization Schema", description: "Generate Organization structured data", category: "seo", icon: Globe, implemented: false },
  { id: "person-schema-gen", name: "Person Schema Generator", description: "Generate Person structured data", category: "seo", icon: PenTool, implemented: false },
  { id: "job-posting-schema", name: "Job Posting Schema", description: "Generate JobPosting structured data", category: "seo", icon: FileText, implemented: false },
  { id: "course-schema-gen", name: "Course Schema Generator", description: "Generate Course structured data", category: "seo", icon: BookOpen, implemented: false },
  { id: "software-schema-gen", name: "Software Schema Generator", description: "Generate SoftwareApplication schema", category: "seo", icon: Cpu, implemented: false },
  { id: "page-speed-analyzer", name: "Page Speed Analyzer", description: "Analyze page speed optimization tips", category: "seo", icon: Gauge, implemented: false },
  { id: "core-web-vitals", name: "Core Web Vitals Guide", description: "Check and improve Core Web Vitals", category: "seo", icon: Activity, implemented: false },
  { id: "mobile-friendly-test", name: "Mobile Friendly Tester", description: "Test if pages are mobile-friendly", category: "seo", icon: Smartphone, implemented: false },
  { id: "amp-validator", name: "AMP Validator", description: "Validate AMP HTML pages", category: "seo", icon: Zap, implemented: false },
  { id: "rich-snippet-tester", name: "Rich Snippet Tester", description: "Test and preview rich snippets", category: "seo", icon: Star, implemented: false },
  { id: "seo-audit-checklist", name: "SEO Audit Checklist", description: "Complete SEO audit checklist generator", category: "seo", icon: CheckCircle, implemented: false },
  { id: "technical-seo-checker", name: "Technical SEO Checker", description: "Check technical SEO factors", category: "seo", icon: Settings, implemented: false },
  { id: "crawl-budget-calc", name: "Crawl Budget Calculator", description: "Estimate and optimize crawl budget", category: "seo", icon: Calculator, implemented: false },
  { id: "index-coverage-checker", name: "Index Coverage Analyzer", description: "Analyze page indexing status", category: "seo", icon: Search, implemented: false },
  { id: "duplicate-content-check", name: "Duplicate Content Checker", description: "Find duplicate content issues", category: "seo", icon: Copy, implemented: false },
  { id: "thin-content-finder", name: "Thin Content Finder", description: "Identify thin content pages", category: "seo", icon: AlertTriangle, implemented: false },
  { id: "image-seo-checker", name: "Image SEO Checker", description: "Check image alt tags and optimization", category: "seo", icon: Image, implemented: false },
  { id: "video-seo-checker", name: "Video SEO Checker", description: "Optimize video content for search", category: "seo", icon: Video, implemented: false },
  { id: "local-seo-checker", name: "Local SEO Checker", description: "Audit local SEO optimization factors", category: "seo", icon: MapPin, implemented: false },
  { id: "ecommerce-seo-checker", name: "E-commerce SEO Checker", description: "Audit e-commerce SEO factors", category: "seo", icon: DollarSign, implemented: false },
  { id: "blog-seo-analyzer", name: "Blog Post SEO Analyzer", description: "Analyze blog posts for SEO quality", category: "seo", icon: BookOpen, implemented: false },
  { id: "seo-title-case", name: "SEO Title Case Converter", description: "Convert titles to SEO-friendly case", category: "seo", icon: Type, implemented: false },
  { id: "seo-url-analyzer", name: "URL SEO Analyzer", description: "Analyze URLs for SEO best practices", category: "seo", icon: Link, implemented: false },
  { id: "redirect-map-gen", name: "Redirect Map Generator", description: "Create 301 redirect mapping spreadsheets", category: "seo", icon: RefreshCw, implemented: false },
  { id: "xml-sitemap-gen-adv", name: "Advanced Sitemap Generator", description: "Generate sitemaps with priority & frequency", category: "seo", icon: List, implemented: false },
  { id: "html-sitemap-gen", name: "HTML Sitemap Generator", description: "Generate HTML sitemaps for users", category: "seo", icon: List, implemented: false },
  { id: "news-sitemap-gen", name: "News Sitemap Generator", description: "Generate Google News sitemaps", category: "seo", icon: FileText, implemented: false },
  { id: "image-sitemap-gen", name: "Image Sitemap Generator", description: "Generate image sitemaps for SEO", category: "seo", icon: Image, implemented: false },
  { id: "video-sitemap-gen", name: "Video Sitemap Generator", description: "Generate video sitemaps for SEO", category: "seo", icon: Video, implemented: false },
  { id: "google-analytics-gen", name: "GA4 Tag Generator", description: "Generate Google Analytics 4 tracking code", category: "seo", icon: BarChart, implemented: false },
  { id: "gtm-code-gen", name: "GTM Code Generator", description: "Generate Google Tag Manager snippets", category: "seo", icon: Code, implemented: false },
  { id: "conversion-rate-calc", name: "Conversion Rate Calculator", description: "Calculate website conversion rates", category: "seo", icon: Percent, implemented: false },
  { id: "roi-calculator", name: "SEO ROI Calculator", description: "Calculate return on SEO investment", category: "seo", icon: DollarSign, implemented: false },
  { id: "traffic-estimator", name: "Traffic Estimator", description: "Estimate organic traffic potential", category: "seo", icon: TrendingUp, implemented: false },
  { id: "ab-test-calc", name: "A/B Test Calculator", description: "Calculate A/B test statistical significance", category: "seo", icon: BarChart, implemented: false },
  { id: "click-through-calc", name: "CTR Calculator", description: "Calculate and optimize click-through rates", category: "seo", icon: Percent, implemented: false },
  { id: "bounce-rate-analyzer", name: "Bounce Rate Analyzer", description: "Analyze and improve bounce rates", category: "seo", icon: Activity, implemented: false },
  { id: "page-authority-calc", name: "Page Authority Estimator", description: "Estimate page authority scores", category: "seo", icon: Award, implemented: false },
  { id: "domain-authority-calc", name: "Domain Authority Estimator", description: "Estimate domain authority metrics", category: "seo", icon: Award, implemented: false },
  { id: "competitor-seo-analyzer", name: "Competitor SEO Analyzer", description: "Compare SEO metrics vs competitors", category: "seo", icon: BarChart, implemented: false },
  { id: "featured-snippet-opt", name: "Featured Snippet Optimizer", description: "Optimize content for featured snippets", category: "seo", icon: Star, implemented: false },
];
